...
async function connectUsingChromeProfile(
    ...
    //
    // مهم:
    // لا نحتاج group event update في هذا البوت.
    //
    // updateThumbnail() قد ينتج عنه event update
    // والـ handler في wolf.js 2.7.10 قد يحاول
    // معالجة تحديث بدون id.
    // ========================================================
...
async function uploadThumbnails(
    ...
    for (
        ...
        try {
            ...
            // wolf.js 2.7.10
            //
            // updateThumbnail(eventId, thumbnail)
            // =================================================
            ...
            if (
                ...
                // بعض إصدارات API قد لا ترجع success
                // بنفس الشكل، لكن عدم وجود exception
                // يعني أن الطلب نفسه اكتمل.
                successCount++;
